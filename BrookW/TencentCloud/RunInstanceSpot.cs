...
namespace BrookW.Service
{
    public class RunInstanceSpot
    {
        ...
        /// <returns></returns>
        public string[]? RunInstancesByLaunchTemplate(string secretId, string secretKey, string launchTemplateId = "lt-d1jlkcyq")
        {
        ...
        /// <param name="secretKey"></param>
        /// <returns></returns>
        public string? GetInstancesPublicIp(string[] instanceIds, string secretId, string secretKey)
        {
        ...
        /// <param name="secretKey"></param>
        /// <returns></returns>
        public bool TerminateInstances(string[] instanceIds, string secretId, string secretKey)
        {
            Credential cred = new Credential
            {
                SecretId = secretId,
